...
use App\Caches\CourseTeacherListCache;
...
class BasicInfoService extends LogicService
{
    ...
    public function handleBasicInfo(Course $course)
    {
    ...
    protected function handleRatings(Course $course)
    {
    ...
    protected function handleTeachers(Course $course)
    {
