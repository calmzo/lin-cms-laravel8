...
class CourseScoreService extends BaseService
{
    ...
    protected function calculateFreeCourseScore(Course $course)
    {
        $weight = [
            'factor1' => 0.1,
            'factor2' => 0.25,
    ...
    protected function calculateChargeCourseScore(Course $course)
    {
        $weight = [
            'factor1' => 0.1,
            'factor2' => 0.3,
    ...
    protected function calculateCourseScore(Course $course, $weight)
    {
        $items = [
            'factor1' => 0.0,
            'factor2' => 0.0,
